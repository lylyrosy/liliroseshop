...
}, [mydb]); // si on laisse [mydb] vide ya que le first runder qui sera affiché il faudrait raffraichir la page dans le cas du delete sinon  use my effect ne fera pas la maj automatiquement 
